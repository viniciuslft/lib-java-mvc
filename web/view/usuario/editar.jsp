...
<div class="main-container">
                    ...
                    <div class="icon-inner-container">
                        <div class="icon-layout">
                            <div class="icon-sidebar">
                                <h2><img src="<%= request.getContextPath() %>/view/assets/icons/desktop_old-0.png" alt="" width="32" height="32"><br>Editar</h2>
                                <p class="LogoLine"><img src="https://98.js.org/src/WEB//wvline.gif" width="100%" height="1px"></p>
                                <p>Altere os dados<br>do usuário selecionado.</p>
                            </div>
                            <div class="icon-main p-4">
                                <form action="${pageContext.request.contextPath}/usuario/editar" method="post" class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="endereco" name="endereco" value="<%= u.getEndereco() %>">
                                    </div>
    ...
    <div class="start-bar">
        ...
        <span class="start-bar-window">
            <div class="sprite gallery"></div>Editando usuário
        </span>
        <span class="made-by">
