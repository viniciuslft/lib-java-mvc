...
<div class="main-container">
                    ...
                    <div class="icon-inner-container">
                        <div class="icon-layout">
                            <div class="icon-sidebar">
                                <h2><img src="<%= request.getContextPath() %>/view/assets/icons/help_book_cool-4.png" alt="" width="32" height="32"><br>Cadastrar</h2>
                                <p class="LogoLine"><img src="https://98.js.org/src/WEB//wvline.gif" width="100%" height="1px"></p>
                                <p>Adicione um novo<br>livro ao sistema.</p>
                            </div>
                            <div class="icon-main p-4">
                                <form action="<%= request.getContextPath() %>/livro" method="post" class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" id="quantidadeDisponivel" name="quantidadeDisponivel" value="1">
                                    </div>
                                    ...
                                    <div class="col-12 mt-3">
                                        <button type="submit" class="win98-button">
                                            <img src="<%= request.getContextPath() %>/view/assets/icons/save-1.png" alt="Cadastrar" width="16" height="16"> Cadastrar Livro
                                        </button>
    ...
    <div class="start-bar">
        ...
        <span class="start-bar-window">
            <div class="sprite gallery"></div>Cadastrando livro
        </span>
        <span class="made-by">
